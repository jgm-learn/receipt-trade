...
func (this *MarketController) Delist() {
	...
	o.QueryTable("user_funds").Filter("user_id", orderBuy.UserId).One(&userFunds)
	...
	_, err = o.QueryTable("list").Filter("list_id", orderBuy.ListId).Update(orm.Params{
	...
	*/
	...
	//更新买方user_receipt表
	err = o.QueryTable("user_receipt").Filter("user_id", orderBuy.UserId).Filter("receipt_id", orderBuy.ReceiptId).One(&userReceipt)
	if err == orm.ErrNoRows {
	...
	//更新卖方user_funds表
	_, err = o.QueryTable("user_funds").Filter("user_id", list.UserId).Update(orm.Params{
	...
	//更新买方user_funds表
	_, err = o.QueryTable("user_funds").Filter("user_id", orderBuy.UserId).Update(orm.Params{
